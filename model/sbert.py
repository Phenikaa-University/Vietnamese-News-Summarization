...
df_test["extractive_summary"] = df_test["document"].apply(lambda x: extractive_summary(x, model=extractive_model, ratio=0.008))
df_test.to_csv("dataset/final/news-mds-extractive_008.csv", index=False)